...
public interface RentInfoDao {
    ...
    @Insert("insert into tb_realname_certification(IDIMAGEFOUNTVAR,IDIMAGEBACKVAR,creditimg,valueimg) values(#{fontimg},#{backimg},#{creditimg},#{valueimg}) where userid=#{userid}")
