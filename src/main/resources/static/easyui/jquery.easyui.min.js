...
$.fn.linkbutton.defaults={id:null,disabled:false,toggle:false,selected:false,outline:false,group:null,plain:false,text:"",iconCls:null,iconAlign:"left",size:"small",'@click:function(){
}};
})(jQuery);
(function($){
function _ac(_ad){
...
a[0].'@click=eval(btn.handler||function(){
});
...
_189(_e4,_e8[0]);
_e5.'@click.call(_e4,_eb(_e4,_e8[0]));
}
}
e.stopPropagation();
...
tool[0].'@click=eval(btn.handler||function(){
});
...
if(!opts.buttons){
opts.buttons=[{text:opts.ok,'@click:function(){
_2c5(dlg);
}}];
}
var dlg=_2ca(opts);
...
opts.buttons=[{text:opts.ok,'@click:function(){
_2c5(dlg,true);
}},{text:opts.cancel,'@click:function(){
_2c5(dlg,false);
}}];
}
var dlg=_2ca(opts);
...
var td=$("<td></td>").appendTo(tr);
var tool=$("<a href=\"javascript:;\"></a>").appendTo(td);
tool[0].'@click=eval(opts.tools[i].handler||function(){
});
...
var item=$(div);
var _430=$.extend({},$.parser.parseOptions(item[0],["id","name","iconCls","href",{separator:"boolean"}]),{disabled:(item.attr("disabled")?true:undefined),text:$.trim(item.html()),'@click:item[0].'@click},_42f||{});
_430.'@click=_430.'@click||_430.handler||null;
...
if(_430.'@click){
if(typeof _430.'@click=="string"){
item.attr("'@click",_430.'@click);
}else{
item[0].'@click=eval(_430.'@click);
}
}
if(_430.disabled){
...
opts.'@click.call(_449,$(_449).menu("getItem",item[0]));
}
};
...
btn.addClass("textbox-button-"+opts.buttonAlign).linkbutton({text:opts.buttonText,iconCls:opts.buttonIcon,'@click:function(){
var t=$(this).parent().prev();
t.textbox("options").'@clickButton.call(t[0]);
}});
}
if(opts.label){
if(typeof opts.label=="object"){
...
_6b4.linkbutton({iconCls:opts.reversed?"spinner-button-up":"spinner-button-down",'@click:function(){
_6b6(_6a9,!opts.reversed);
}});
_6b5.linkbutton({iconCls:opts.reversed?"spinner-button-down":"spinner-button-up",'@click:function(){
_6b6(_6a9,opts.reversed);
}});
if(opts.disabled){
...
opts.'@clickCell.call(_769,_76a,_76d,row[_76d]);
}
...
opts.'@clickRow.apply(_769,_6ed(_769,[_76a,row]));
}
};
function _772(e){
var tr=_763(e.target);
...
},'@clickRow:function(_91e,_91f){
},onDblClickRow:function(_920,_921){
},'@clickCell:function(_922,_923,_924){
...
},'@clickCell:function(_951,_952,_953){
if(_94b!=this){
_94c(_94b);
_94b=this;
}
...
opts.'@clickCell.call(_94e,_951,_952,_953);
},loadFilter:function(data){
_94c(this);
...
},'@clickCell:function(_9ba,_9bb){
opts.'@clickCell.call(_9b4,_9bb,find(_9b4,_9ba));
...
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_bae,'@clickRow:_baf,onSelect:_bb0("onSelect"),onUnselect:_bb0("onUnselect"),onSelectAll:_bb0("onSelectAll"),onUnselectAll:_bb0("onUnselectAll")}));
function _bb1(dg){
...
opts.'@clickRow.call(this,_bb5,row);
};
function _bb0(_bb9){
...
var _c2c=$(_c2a).tagbox("getValues");
opts.'@clickTag.call(_c2a,_c2c[_c2b]);
}
}
